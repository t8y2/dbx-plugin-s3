...
Generated by `dbx-plugin create` with the **Frontend only (universal)** template. This project has no native backend and produces one cross-platform `universal` package.
